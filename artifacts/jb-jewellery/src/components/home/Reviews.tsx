          ...
          {items.map((rev) => (
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                <div className="w-10 h-10 rounded-full bg-primary/20 text-primary font-black flex items-center justify-center text-lg">
                  {rev.initial}
                </div>
                <div>
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    <span className="text-[10px] text-green-600 font-bold uppercase tracking-wider">Verified Buyer</span>
                  </div>
                </div>
              </div>
